...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"BrakeIndicator", PERSISTENT},
    {"PowerMeterMode", PERSISTENT},
    {"PowerMeterMetric", PERSISTENT},
    ...
    {"EVConsumption5Mi", PERSISTENT},
    {"EVConsumptionTripkWh", PERSISTENT},
    {"TripDistance", PERSISTENT},
    {"NumberOfDisengagements", PERSISTENT},
    {"NumberOfInterventions", PERSISTENT},
    {"NumberOfInteractions", PERSISTENT},
    {"NumberOfDistractions", PERSISTENT},
    {"CarSecondsRunning", PERSISTENT},
    {"EngagedDistance", PERSISTENT},
    {"OpenPilotSecondsEngaged", PERSISTENT},
    {"MetricResetSwitch", PERSISTENT},
    ...
    {"MeasureSlot02", PERSISTENT},
    {"MeasureSlot03", PERSISTENT},
    {"MeasureSlot04", PERSISTENT},
    {"MeasureSlot05", PERSISTENT},
    {"MeasureSlot06", PERSISTENT},
    {"MeasureSlot07", PERSISTENT},
    {"MeasureSlot08", PERSISTENT},
    {"MeasureSlot09", PERSISTENT},
    ...
    {"Coasting", PERSISTENT},
    {"CoastingActive", PERSISTENT},
    {"CoastingDL", PERSISTENT},
