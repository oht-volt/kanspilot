...
CommunityPanel::CommunityPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggleLayout->addWidget(new CValueControl("AutoNaviSpeedSafetyFactor", "SpeedCameraSafetyFactor(99%)", "", ".. / assets / offroad / icon_road.png", 80, 120, 1));
...
CruisePanel::CruisePanel(QWidget* parent) : QWidget(parent) {
    ...
    toggleLayout->addWidget(new CValueControl("AutoResumeFromGasSpeed", "GAS CRUISE ON: Speed(30)", "Driving speed exceeds the set value, Cruise ON", "../assets/offroad/icon_road.png", 0, 140, 1));
