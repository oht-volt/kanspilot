...
def plannerd_thread(sm=None, pm=None):
  ...
  if sm is None:
    sm = messaging.SubMaster(['carControl', 'carState', 'controlsState', 'radarState', 'modelV2', 'liveMapData', 'liveParameters'],
                             poll=['radarState', 'modelV2'], ignore_avg_freq=['radarState', 'liveMapData'])
