...
def manager_init() -> None:
  ...
  default_params: List[Tuple[str, Union[str, bytes]]] = [
    ...
    ("ShowPathMode", "12"),
    ("ShowPathColor", "13"),
    ("ShowPathModeCruiseOff", "12"),
    ("ShowPathColorCruiseOff", "18"),
    ("ShowPathModeLane", "12"),
    ...
    ("StopDistance", "650"), 
    ("CustomMapbox", "0"),    
    ("LongitudinalTuningKpV", "85"),     
    ("LongitudinalTuningKiV", "0"),     
    ("LongitudinalTuningKf", "85"),     
    ("LongitudinalActuatorDelayUpperBound", "20"),     
    ("LongitudinalActuatorDelayLowerBound", "15"),     
    ("EnableRadarTracks", "0"),      
    ("EnableAutoEngage", "0"),      
